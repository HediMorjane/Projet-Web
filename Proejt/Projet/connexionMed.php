      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <li class="nav-item">
            <div class="dropdown text-end">
              ...
              <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                ...
                <li><a class="dropdown-item" href="#">Afficher mes rendez-vous</a></li>
                <!--<li><a class="dropdown-item" href="#">Profile</a></li>-->
              </ul>
            </div>
          </li>
        ...
        <script>
                function ouvrirPage() {
                    ...
                    if (a === "accueil") {
                        window.open("/Users/romai/OneDrive/Bureau/HTML%20ECE/Projet%20Webdynamique/accueil.html");
                    }

                    if (a === "compte") {
                        window.open("/Users/romai/OneDrive/Bureau/HTML%20ECE/Projet%20Webdynamique/Compte.html");
                    }
...
<div class="container">
    ...
    <div class="py-5 text-center">
        <h2>Connexion à votre compte médecin</h2>
        ...
        <form class="needs-validation" method="POST" action="" novalidate>
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="JacquesDupont@exemple.com" required>
                ...
                <div class="col-md-5">
                <label for="spe" class="form-label">Spécialité du médecin</label>
                <select class="form-select" name="spe" required>
                ...
                <button class="w-100 btn btn-primary btn-lg" type="submit" name="submit">Connexion</button>
            </div>
        </form> 
    </div>  
</div>
...
if(isset($_POST['email'])){
    ...
    $password=($_POST['mdp']);
    $sql="SELECT * from medecinge where Email='".$mail."' AND MotdePasse='".$password."' limit 1 ";
...
if(mysqli_num_rows($result)==1){
   ...
   // echo 'window.location.href"="connexion.php';
    ...
    if(isset($_POST['email'])){
        ...
        $password=($_POST['mdp']);
        $sql="SELECT * from medecinspe where Email='".$mail."' AND MotdePasse='".$password."' limit 1 ";
