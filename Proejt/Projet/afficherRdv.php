          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <script>
                    function ouvrirPage() {
                        ...
                        if (a === "accueil") {
                            window.open("Projet%20Webdynamique/accueil.html");
                        }
    
                        if (a === "compte") {
                            window.open("Projet%20Webdynamique/Compte.html");
                        }
...
<main>
  <!--Code pour texte en haut de page-->
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Bonjour </h1>
        <?php echo $_SESSION['email'];?>
        <p class="lead text-muted">Voici les rendez-vous que vous avez</p>
      </div>
    </div>
  </section>
  ...
  <div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 text-muted">Copyright &copy; 2022 Omnes santé</span>
      </div>
...
if(!$conn){
    ...
    //$sql="SELECT * from rendezvous where MailClient='".$_SESSION['email']."' limit 1 ";
    //$sql="SELECT DateRDV,Heure,NomMedGe,NomClient,Salle,NomMedSpe,TypeRDV FROM rendezvous WHERE MailClient='hedi@gmail.com' ";
    //'".$_SESSION['email']."' 
    $recuputilisateur= $conn->prepare('SELECT * FROM rendezvous WHERE MailClient = ? ');
    $recuputilisateur->execute(array($_SESSION['email']));
/*
