...
if($db_found){
    ...
    {//reponse du bouton showall
        ...
        {
            $MedGe=$_POST["MedGe"];
            $sql="SELECT DateRDV,Heure,NomMedGe,NomClient,Salle,NomMedSpe,TypeRDV FROM rendezvous WHERE NomMedGe='$MedGe'";   
        }
        if(!empty($_POST["MedSpe"]))
        {
            $MedSpe=$_POST["MedSpe"];
            $sql="SELECT DateRDV,Heure,NomMedGe,NomClient,Salle,NomMedSpe,TypeRDV FROM rendezvous WHERE NomMedSpe='$MedSpe'";
        }
        if(!empty($_POST["Client"]))
        {
            $client=$_POST["Client"];
            $sql="SELECT DateRDV,Heure,NomMedGe,NomClient,Salle,NomMedSpe,TypeRDV FROM rendezvous WHERE NomClient='$client'";
        }
    ...
    {//reponse du bouton showall
        ...
        $sql="INSERT INTO rendezvous (DateRDV,Heure,NomMedGe,NomClient,Salle,NomMedSpe,TypeRDV) VALUES ('$date','$heure','$MedGe','$client','$salle','$MedSpe','$typerdv')";
        $res=mysqli_query($db_handle,$sql);
        echo "<br>";
    ...
    {//reponse du bouton showall
        try{ 
            ...
            {
                $client=$_POST["Client"];
                $sql="DELETE FROM rendezvous WHERE NomClient='$client'";  
            }
        $res=mysqli_query($db_handle,$sql);
        echo "<br>";
