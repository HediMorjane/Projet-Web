...
<html lang="en">
  <head>
    ...
    <title>Omnes santé|Medecins Specialiste</title>
...
if($db_found){
        ...
        while($data=mysqli_fetch_assoc($res)){
            ...
            echo '
            <a  href="rdvmedge.php" title="Prendre RDV"> <button name="RDV" >
                        Prendre RDV
                    </button></a>';
            echo "   ";
            echo'<a href="afficherRDV.html" title="RDV du medecin"> <button id="button">
            RDV du medecin
        </button></a>';
            echo "   ";
