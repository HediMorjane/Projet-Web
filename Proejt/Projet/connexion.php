...
<div class="container">
    ...
    <div class="col-md-7 col-lg-8">
        ...
        <p class="lead">Vous n'avez pas encore de compte ?<a href="créerUnCompte.html"> Cliquez ici pour en créer un.</a></p>
    </div>  
</div>
...
if(isset($_POST['email'])){
    ...
    $sql="SELECT * from client where Mail='".$mail."' AND MotdePasse='".$password."' limit 1 ";
